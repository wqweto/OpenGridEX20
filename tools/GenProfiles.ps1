...
[void]$oSb.AppendLine("")
[void]$oSb.AppendLine("Private m_uProps()                  As UcsProfileProp")
...
[void]$oSb.AppendLine("    ReDim m_uProps(0 To $($aEntries.Count - 1)) As UcsProfileProp")
...
[void]$oSb.AppendLine("        If m_uProps(lIdx).sClass = sClass Then")
[void]$oSb.AppendLine("            uProps(ProfileForClass) = m_uProps(lIdx)")
...
[void]$oSb.AppendLine("    With m_uProps(m_lCount)")
