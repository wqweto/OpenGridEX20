...
| `RecordNavigator` | `Boolean` | verified | `pvPaintNavigator` | M3d | -- | `030-record-navigator` (True) vs default False |
| `RecordNavigatorString` | `String` | weak | `pvNavLayout` | M3d | -- | rendered at its default `Record:|of` only |
